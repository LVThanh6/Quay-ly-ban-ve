...
public class ChiTietPhieuDat {
    ...
    public String getMaChiTietPhieuDat() { return maChiTietPhieuDat; }
    public void setMaChiTietPhieuDat(String maChiTietPhieuDat) { this.maChiTietPhieuDat = maChiTietPhieuDat; }

    public double getGiaTamTinh() { return giaTamTinh; }
    public void setGiaTamTinh(double giaTamTinh) { this.giaTamTinh = giaTamTinh; }
