...
public class SuatChieu {
    ...
    public SuatChieu(String maSuatChieu, LocalDateTime thoiGianKhoiChieu, double giaVeCoBan, Phim phim,
    ...
    public LocalDateTime getThoiGianKhoiChieu() {
        return thoiGianKhoiChieu;
    }

    public void setThoiGianKhoiChieu(LocalDateTime thoiGianKhoiChieu) {
        this.thoiGianKhoiChieu = thoiGianKhoiChieu;
    }
